const TRANSLATIONS = {
  fr: {
    ...
    'platform.desc':      'Gérez vos rendez-vous, suivez vos clients et communiquez en temps réel depuis une interface simple, rapide et sécurisée.',
    // Left panel
  ...
  en: {
    ...
    'platform.desc':      'Manage your appointments, track your clients and communicate in real time from a simple, fast and secure interface.',
    'panel.refill':       'Needs refill soon',
    'panel.prescription': 'Others by prescription',
    'order.btn':          'Place Order',
    ...
    'search.clients':      'Search a client…',
  ...
  ar: {
    ...
    'page.clients':       'قائمة العملاء',
    'page.messages':      'الرسائل',
    'search.appointments': 'البحث عن موعد…',
    'search.clients':      'البحث عن عميل…',
